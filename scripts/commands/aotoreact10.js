...
if ( event.body.indexOf("ludo")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
			}
			api.sendMessage(msg, threadID, messageID);
...
if ( event.body.indexOf("লুডু")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
			}
			api.sendMessage(msg, threadID, messageID);
...
if ( event.body.indexOf("🏳️‍⚧️")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
			}
			api.sendMessage(msg, threadID, messageID);
    api.setMessageReaction("🏳️‍⚧️", event.messageID, (err) => {}, true)
   };
if ( event.body.indexOf("🇧🇩")==0 && !bot.includes(event.senderID))  {
		var msg = {
				body: ""
